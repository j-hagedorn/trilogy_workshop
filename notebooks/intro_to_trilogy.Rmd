...
The table above shows the distinct count of motifs and tale types in Trilogy datasets. 
...
Consider visualizing intersections between sets using an [upset graph](https://github.com/hms-dbmi/UpSetR/).
