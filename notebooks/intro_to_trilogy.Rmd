...
The `tmi` is comprised of `r n_distinct(tmi$id)` distinct motifs.  It is grouped into `r n_distinct(tmi$chapter_id)` chapters, including: *`r paste(unique(tmi$chapter_name), collapse = ", ")`*
